/**
 * SNAPSHOT — ex-`config/sites.ts` avant A1 (2026-08-23).
 *
 * Ces données ont été migrées dans la table Supabase `site_profiles` par
 * `scripts/seed-site-registry.ts`, qui est le seul module à encore lire ce
 * fichier. Aucun code de production ne l'importe : la source de vérité est la
 * base. Conservé pour la traçabilité de la migration, à supprimer en A2.
 */

import type { SiteConfig, ServiceDef } from './site-types.js';

export type { SiteConfig, ServiceDef };
...
export const sites: Record<string, SiteConfig> = {
  ...
  okaz: {
    key: 'okaz',
    name: 'Okaz Autos 66',
    domain: 'https://www.okaz-autos66.com',
    business: 'Vente de voitures d\'occasion - Saleilles & Perpignan',
    phone: '06 51 65 19 87',
    email: 'contact@okaz-autos66.com',
    address: '12 rue Marcellin Berthelot',
    postalCode: '66280',
    city: 'Saleilles',
    schemaType: 'AutoDealer',
    projectPath: '/home/ubuntu/sites/Okaz-autos',
    dataStrategy: 'data-files',
    serviceDataFile: 'data/vehicles.ts',
    cityDataFile: 'data/cities.ts',
    slugPageFile: 'app/[slug]/page.tsx',
    vercelHookEnv: 'VERCEL_HOOK_OKAZ',
    telegramChatEnv: 'TELEGRAM_CHAT_OKAZ',
    services: [
      { slug: 'voiture-occasion', name: 'Voiture d\'occasion', emoji: '🚗', category: 'vente', keywords: ['voiture occasion', 'véhicule occasion', 'auto occasion'] },
      { slug: 'suv-occasion', name: 'SUV d\'occasion', emoji: '🚙', category: 'vente', keywords: ['SUV occasion', '4x4 occasion', 'crossover occasion'] },
      { slug: 'citadine-occasion', name: 'Citadine d\'occasion', emoji: '🏙️', category: 'vente', keywords: ['citadine occasion', 'petite voiture occasion'] },
      { slug: 'berline-occasion', name: 'Berline d\'occasion', emoji: '🚘', category: 'vente', keywords: ['berline occasion', 'familiale occasion'] },
      { slug: 'depot-vente', name: 'Dépôt-vente', emoji: '🤝', category: 'service', keywords: ['dépôt vente voiture', 'depot vente auto', 'vendre sa voiture'] },
      { slug: 'carte-grise', name: 'Carte grise', emoji: '📄', category: 'service', keywords: ['carte grise', 'certificat immatriculation', 'changement titulaire'] },
      { slug: 'reprise-vehicule', name: 'Reprise de véhicule', emoji: '🔄', category: 'service', keywords: ['reprise véhicule', 'rachat voiture', 'reprise auto'] },
    ],
    seoKeywordPatterns: [
      'voiture occasion {ville}',
